// -----------------------------------------------------------------------
//  <copyright file="IRepository.cs" company="DLYB">
//      Copyright (c) 2014-2015 DLYB. All rights reserved.
//  </copyright>
//  <last-editor>@DLYB</last-editor>
//  <last-date>2015-04-22 15:46</last-date>
// -----------------------------------------------------------------------
...
namespace Infrastructure.Core
{
    ...
    public interface IRepository<TEntity, TKey> : IDependency where TEntity : IEntity
    {
        #region 属性
        ...
        /// <returns></returns>
        int Update(TEntity entity, List<string> lstColumns);
        ...
        int SqlExcute(string sql, params object[] parameters);
