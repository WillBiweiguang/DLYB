...
namespace Infrastructure.Core.Plugins
{
    ...
    public partial class OfficialFeedManager : IOfficialFeedManager
    {
        ...
        public virtual List<OfficialFeedPlugin> GetAllPlugins(int categoryId = 0,
            ...
            int pageIndex = 0, int pageSize = int.MaxValue)
        {
            ...
            return new List<OfficialFeedPlugin>();// PagedList<OfficialFeedPlugin>(list, pageIndex, pageSize, totalRecords);
        }
    }
}
