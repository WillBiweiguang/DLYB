...
namespace Infrastructure.Core.Plugins
{
    public class PluginDescriptor : IComparable<PluginDescriptor>
    {
        ...
        public virtual List<string> Controllers { get; set; }

        public virtual List<string> Dependences { get; set; }
        ...
        /// </summary>
        public virtual string RuntimeInformation { get; set; }

        /// <summary>
        /// neet to install. insatll flag = -1
        /// </summary>
        public virtual bool NeedInstalled { get; set; }

        /// <summary>
        /// the path of the install temp file
        /// </summary>
        public virtual string InstallFrom { get; set; }
