...
namespace Infrastructure.Core.Config.Info
{
    [Description("站点信息配置")]
    public class SiteConfigInfo : ConfigBase
    {
        ...
        private string _siteName = "DLYB.NET平台";//站点名称
        private string _siteurl = "";//网站网址
        private string _sitetitle = "DLYB.NET通用平台";//网站标题
        private string _seokeyword = "DLYB.NET通用平台";//seo关键字
        private string _seodescription = "DLYB.NET框架是一套插件框架，以方便中间件的选择、组装和集成";//seo描述
