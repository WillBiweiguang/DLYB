...
namespace Infrastructure.Core.Infrastructure
{
    ...
    /// </summary>
    public partial class WebCoreConfig : IConfigurationSectionHandler
    {
        /// <summary>
        ...
        public object Create(object parent, object configContext, XmlNode section)
        {
            ...
            var SupperUser = section.SelectSingleNode("SupperUser");
            if (SupperUser != null )
            {
                config.SupperUser = SupperUser.InnerText;
            }
        ...
        public string SupperUser { get; private set; }
        /// <summary>
