...
namespace Infrastructure.Core.Infrastructure.DependencyManagement
{
    public class ContainerManager
    {
        ...
        public object ResolveUnregistered(Type type, ILifetimeScope scope = null)
        {
            ...
            foreach (var constructor in constructors)
            {
                try
                {
                    ...
                    foreach (var parameter in parameters)
                    {
                        ...
                        if (service == null) throw new DLYBException("Unkown dependency");
            ...
            throw new DLYBException("No contructor was found that had all the dependencies satisfied.");
        }
