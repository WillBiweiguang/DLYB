// -----------------------------------------------------------------------
//  <copyright file="CachingLoggerAdapterBase.cs" company="DLYB">
//      Copyright (c) 2014 DLYB. All rights reserved.
//  </copyright>
//  <last-editor>@DLYB</last-editor>
//  <last-date>2015-04-22 22:15</last-date>
// -----------------------------------------------------------------------
...
using Infrastructure.Utility.Properties;
...
namespace Infrastructure.Core.Logging
{
    ...
    public abstract class LoggerAdapterBase : ILoggerAdapter
    {
        ...
        private ILog GetLoggerInternal(string name)
        {
            ...
            if (log == null)
            {
                throw new NotSupportedException(name);//Resources.Logging_CreateLogInstanceReturnNull.FormatWith(name, GetType().FullName));
            }
