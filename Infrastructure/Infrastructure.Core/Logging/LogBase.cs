// -----------------------------------------------------------------------
//  <copyright file="LoggerBase.cs" company="DLYB">
//      Copyright (c) 2014 DLYB. All rights reserved.
//  </copyright>
//  <last-editor>@DLYB</last-editor>
//  <last-date>2015-04-22 22:10</last-date>
// -----------------------------------------------------------------------
...
namespace Infrastructure.Core.Logging
{
    ...
    public abstract class LogBase : ILog
    {
        ...
        public virtual void Error<T>( Exception exception,T message)
        {
            if (IsErrorEnabled)
            {
        ...
        /// <param name="message">日志消息</param>
        /// <param name="exception">异常</param>
        public virtual void Fatal<T>(Exception exception,T message )
        {
            if (IsFatalEnabled)
            {
