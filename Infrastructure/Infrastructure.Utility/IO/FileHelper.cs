// -----------------------------------------------------------------------
//  <copyright file="FileHelper.cs" company="DLYB">
//      Copyright (c) 2014 DLYB. All rights reserved.
//  </copyright>
//  <last-editor>@DLYB</last-editor>
//  <last-date>2015-04-22 18:25</last-date>
// -----------------------------------------------------------------------
...
namespace Infrastructure.Utility.IO
{
    /// <summary>
    /// 文件辅助操作类
    /// </summary>
    public class FileHelper
    {
        ...
        public static string SaveFile(string filename, byte[] streamByte, bool replaceOld = false)
        {
            try
            {
                ...
                if (!File.Exists(filename) || replaceOld)
                {
