...
namespace Infrastructure.Utility
{
    ...
    public class SharpZip
    {
        ...
        public static void PackFiles(string filename, string directory,  string fileFilter="")
        {
                ...
                fz.CreateZip(filename, directory, true, fileFilter);
                fz = null;

        }


        public static void PackFiles(Stream s, string directory)
        {
        ...
        public static bool UnpackFiles(string file, string dir)
        {
         ...
         return UnpackFiles(File.OpenRead(file),dir);
            //try
            //{
        ...
        public static bool UnpackFiles(Stream fileStream, string dir)
        {
            try
            {
                if (!Directory.Exists(dir))
