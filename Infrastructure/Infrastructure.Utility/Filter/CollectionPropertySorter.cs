// -----------------------------------------------------------------------
//  <copyright file="CollectionPropertySorter.cs" company="DLYB">
//      Copyright (c) 2014-2015 DLYB. All rights reserved.
//  </copyright>
//  <last-editor>@DLYB</last-editor>
//  <last-date>2015-04-22 12:10</last-date>
// -----------------------------------------------------------------------
    ...
    public static class CollectionPropertySorter<T>
    {
        ...
        private static LambdaExpression GetKeySelector(string keyName)
        {
            ...
            foreach (string propertyName in propertyNames)
            {
                ...
                if (property == null)
                {
                    throw new DLYBException(string.Format(Resources.ObjectExtensions_PropertyNameNotExistsInType, propertyName));
                }
