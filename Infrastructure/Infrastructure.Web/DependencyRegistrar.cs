...
using Infrastructure.Utility.Web;
...
namespace Infrastructure.Web
{
    ...
    {
        private static ILogger LoggerMan = LogManager.GetLogger(typeof(DependencyRegistrar));
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder)
        {
            ...
            builder.Register(ctx => new WebWorkContext(ctx.Resolve<HttpContextBase>(), ctx.Resolve<IComponentContext>()))
               .As<WorkContextBase>()
               .InstancePerLifetimeScope();


            //var ExportedTypes =
            //         typeof(Starter).Assembly.GetExportedTypes()
            ...
            //    foreach (var it in item.GetInterfaces()){
            ...
            builder.RegisterType<DefaultLocalizedStringManager>().As<ILocalizedStringManager>().SingleInstance();
           ...
           // builder.RegisterType<UserAgentHelper>().As<IUserAgentHelper>().InstancePerLifetimeScope();
            ...
            var Ass = typeFinder.GetAssemblies();

            
            LoggerMan.Debug("GetAssemblies:" +string.Join("  ,  ", Ass.Select(a=>a.GetName()).ToList()));

            //controllers
            builder.RegisterControllers(Ass.ToArray());
