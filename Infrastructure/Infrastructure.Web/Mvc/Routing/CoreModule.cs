...
using Infrastructure.Core.Paths;
...
namespace Infrastructure.Web.Routing
{
    public class CoreModule : IHttpModule
    {
        static ILogger Log
        {
            get
            {
              return   LogManager.GetLogger("CoreModule");
        ...
        void context_PostResolveRequestCache(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    var siteDefaultUrl = GlobalApplicationObject.Current.ApplicationContext.ConfigManager.GetConfig<Infrastructure.Core.Config.Info.SiteConfigInfo>().SiteDefaultUrl;
