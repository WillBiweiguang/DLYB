// -----------------------------------------------------------------------
//  <copyright file="HostCryptoHubPipelineModule.cs" company="DLYB">
//      Copyright (c) 2014 DLYB. All rights reserved.
//  </copyright>
//  <last-editor>@DLYB</last-editor>
//  <last-date>2015-04-22 12:13</last-date>
// -----------------------------------------------------------------------
...
using Infrastructure.Web.Http.Internal;
using Infrastructure.Web.Properties;


namespace Infrastructure.Web.SignalR.Security
{
    /// <summary>
    /// 服务端Hub数据通信加密解密中间模块
    /// </summary>
