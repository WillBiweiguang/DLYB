...
//        description :
//
//        created by hy at  2014/10/21 21:01:41
//        
//
//======================================================================
namespace Infrastructure.Web
{
    public class GlobalConfigurationManager
    {
        ...
        public static void Config()
        {
            ...
            {
                throw new DLYBException("初始化配置失败！", ex);
            }
        }
        ...
        private static void RegisterBundlesRequest()
        {
            ...
            GlobalApplicationObject.Current.EventsManager.BeginRequest += (requestSender, arg) =>
            {
                ...
                //if (!context.Request.Url.AbsolutePath.StartsWith("/DLYB.", StringComparison.CurrentCultureIgnoreCase))
                //    return;
                //#endregion
        ...
        //    if (count > 1 || count == 0)
        //    {
        //        throw new DLYBException(count > 1 ? "后台程序集只允许存在一个" : "当前环境并不存在后台程序集，请下载");
        //    }
        //    count = MvcConfigManager.MVCPlusList.Where(p => p.MvcPlusType == MvcPlusTypes.MVCHome).Count();
        //    if (count > 1 || count == 0)
        //    {
        //        throw new DLYBException(count > 1 ? "首页程序集只允许存在一个" : "当前环境并不存在首页程序集，请下载");
        //    }
        //}
