...
namespace Infrastructure.Web.Localization.Services
{
    ...
    public class DefaultLocalizedStringManager : ILocalizedStringManager {
       ...
       // private readonly ShellSettings _shellSettings;
        ...
        const string CoreLocalizationFilePathFormat = "~/App_Data/Localization/{0}.po";
        ...
        private CultureDictionary LoadCulture(string culture) {
            ...
            //var obj= CacheManager.GetCacher("Default").Get<CultureDictionary>(culture);
            //if (obj == null)
            //{
            //  var  obj1=LoadTranslationsForCulture(culture,null);
            //  var cultureObj= new CultureDictionary { CultureName = culture, Translations = obj1 };
            //  CacheManager.GetCacher("Default").Set(culture, cultureObj);
            //  return cultureObj;
