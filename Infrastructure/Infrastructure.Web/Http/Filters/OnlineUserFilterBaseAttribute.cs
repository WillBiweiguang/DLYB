// -----------------------------------------------------------------------
//  <copyright file="OnlineUserFilterBaseAttribute.cs" company="DLYB">
//      Copyright (c) 2014-2015 DLYB. All rights reserved.
//  </copyright>
//  <last-editor>@DLYB</last-editor>
//  <last-date>2015-04-22 13:09</last-date>
// -----------------------------------------------------------------------
...
using Infrastructure.Web.Http.Extensions;
using Infrastructure.Web.Security;


namespace Infrastructure.Web.Http.Filters
{
    /// <summary>
