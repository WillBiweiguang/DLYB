...
namespace Infrastructure.Web.Domain.Configuration
{
    ...
    public partial class SysRoleMenuConfiguration : EntityConfigurationBase<SysRoleMenuModel, Int32>
    {
        /// <summary>
        /// 初始化一个<see cref="RoleConfiguration"/>类型的新实例
        /// </summary>
        ...
        {
            SysRoleMenuConfigurationAppend();
        }

        /// <summary>
        /// 额外的数据映射
        /// </summary>
        partial void SysRoleMenuConfigurationAppend();
    ...
    public partial class SysMenuConfiguration : EntityConfigurationBase<SysMenu, Int32>
    {
        /// <summary>
        /// 初始化一个<see cref="RoleConfiguration"/>类型的新实例
        /// </summary>
       ...
       // partial void SysRoleMenuConfigurationAppend();
        ...
        private void SysMenuConfigurationAppend()
        {
            // HasRequired(m => m.Organization).WithMany(n => n.Roles);
            // HasKey(a => new { a.RoleId, a.UserId });
        }
