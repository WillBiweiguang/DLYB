...
namespace DLYB.CA.Entity
{
    ...
    /// <summary>
    /// 示例：
    ///     1. 新闻APP看新闻：(http://chinaca-zgkx.lilly.com:25001/News/ArticleInfo/wxdetail/15)
    ///         UserID  : LillyID
    ///         AppID   : 6
    ...
    ///         Content : Hello
    ///     
    ///     5. 其他网页：(类似1，https://www.chinacmp.lilly.com:25001/News/ArticleInfo/Edit/15)
    ///         UserID  : LillyID
    ///         AppID   : 6
    ...
    public partial class UserBehavior : EntityBase<int>
	{
        ...
        ///     6. faq （index）（属于点击菜单）
        /// 
        ///     7. 在线服务 （raisequestion）/feedback（用户反馈）/Finance（财务查询）(属于点击菜单)
        /// 
