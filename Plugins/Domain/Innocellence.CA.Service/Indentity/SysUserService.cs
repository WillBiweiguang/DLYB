...
namespace Innocellence.CA.Services
{
    ...
    public partial class SysUserService : BaseService<SysUser>, ISysUserService
    {
        ...
        public SysUserService()
        {
            ...
            Store = new UserStore((DbContext)UnitOfWork);
        ...
        {
            SysUser tUser =  Entities.Where(a=>a.UserName==strUser).FirstOrDefault();
            SysUser result;
            if (tUser == null)
            {
        ...
        IUserLockoutStore<SysUser, Int32>
    {
        ...
        public UserStore(DbContext context)
        {
            ...
            _logins = (IDbSet<SysUserLogin>)new BaseService<SysUserLogin>((IUnitOfWork)context).Entities;
            _userClaims = (IDbSet<SysUserClaim>)new BaseService<SysUserClaim>((IUnitOfWork)context).Entities;
            _userRoles = (IDbSet<SysUserRole>)new BaseService<SysUserRole>((IUnitOfWork)context).Entities;
        }
        ...
        {
            get { return _userStore.Entities; }
        }
        ...
        public virtual async Task<IList<string>> GetRolesAsync(SysUser user)
        {
            ...
            var query = from userRole in _userRoles
                        ...
                        join role in _roleStore.Entities on userRole.RoleId equals role.Id
                        select role.Name;
        ...
        public virtual async Task<bool> IsInRoleAsync(SysUser user, string roleName)
        {
            ...
            var role = await _roleStore.Entities.SingleOrDefaultAsync(r => r.Name.ToUpper() == roleName.ToUpper());
            if (role != null)
            {
                var userId = user.Id;
                var roleId = role.Id;
