...
数须另收酱料费5 元/位\n 本单谢绝自带酒水饮料",
        ...
        public void CreateCardTest()
        {
           // var accessToken = AccessTokenContainer.GetAccessToken(_appId);
            ...
            var result = CardApi.CreateCard(_appId, _appSecret, data);
            ...
            var result3 = CardApi.CreateCard(_appId, _appSecret, data3);
            ...
            var result2 = CardApi.CreateCard(_appId, _appSecret, data2);
        ...
        public List<string> CardBatchGetTest()
        {
           // var accessToken = AccessTokenContainer.GetAccessToken(_appId);
            ...
            var result = CardApi.CardBatchGet(_appId, _appSecret, 0, 5);
            Console.Write(result);
            Assert.IsNotNull(result);
        ...
        public void CreateQRTest()
        {
           // var accessToken = AccessTokenContainer.GetAccessToken(_appId);
            ...
            var result = CardApi.CreateQR(_appId, _appSecret, cardId);
            Console.Write(result);
            Assert.IsNotNull(result);
        }
        ...
        public void CardDetailGet()
        {
           ...
           // var accessToken = AccessTokenContainer.GetToken(_appId, _appSecret);
            ...
            var result = CardApi.CardDetailGet(_appId, _appSecret, cardId);
            Console.Write(result);
            Assert.IsNotNull(result);
        }
