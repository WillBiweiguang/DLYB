...
using Innocellence.Weixin.MP.AdvancedAPIs.TemplateMessage;
using Innocellence.Weixin.MP.CommonAPIs;
using Innocellence.Weixin.MP.Test.CommonAPIs;

namespace Innocellence.Weixin.MP.Test.AdvancedAPIs.Template
{
    ...
    public class TemplateTest : CommonApiTest
    {
        ...
        public void SendTemplateMessageTest()
        {
           ...
           // var accessToken = AccessTokenContainer.GetAccessToken(_appId);
            ...
            var result = MP.AdvancedAPIs.TemplateApi.SendTemplateMessage(_appId, _appSecret, openId, templateId, "#FF0000", "http://www.weiweihi.com", testData);
