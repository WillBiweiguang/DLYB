...
namespace Innocellence.Weixin.MP.Test.CommonAPIs.Tests
{
    //已测试通过
    [TestClass]
    public class AccessTokenContainerTest : CommonApiTest
    {
        ...
        public void ContainerTest()
        {
           ...
           // AccessTokenContainer.Register(base._appId, base._appSecret);
            ...
            var tokenResult = AccessTokenContainer.GetTokenResult(base._appId, base._appSecret);
            ...
            //只获取Token字符串
            dt1 = DateTime.Now;
            var token = AccessTokenContainer.GetToken(base._appId, base._appSecret);
            dt2 = DateTime.Now;
            ...
            {
                dt1 = DateTime.Now;
                token = AccessTokenContainer.GetToken(base._appId, base._appSecret, false);
                dt2 = DateTime.Now;
                Assert.AreEqual(tokenResult.access_token, token);
                Console.WriteLine(tokenResult.access_token);
                ...
                dt1 = DateTime.Now;
                token = AccessTokenContainer.GetToken(base._appId, base._appSecret, true);
                dt2 = DateTime.Now;
            ...
            {
                tokenResult = AccessTokenContainer.GetTokenResult(base._appId, base._appSecret);
        ...
        public void GetTokenResultTest()
        {
           ...
           // AccessTokenContainer.Register(base._appId, base._appSecret);
            ...
            {
                var accessTokenResult = AccessTokenContainer.GetTokenResult(base._appId, base._appSecret, false);
