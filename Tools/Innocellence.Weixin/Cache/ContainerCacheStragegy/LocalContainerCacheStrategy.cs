...
namespace DLYB.Weixin.Cache
{
    ...
    public static class LocalCacheHelper
    {
        ...
        /// 所有数据集合的列表
        /// </summary>
        public static IDictionary<string, IBaseContainerBag> LocalCache { get; set; }

        static LocalCacheHelper()
        {
            LocalCache = new ConcurrentDictionary<string, IBaseContainerBag>(StringComparer.OrdinalIgnoreCase);
        }
    }
    ...
    //where TContainerBag : class, AccessTokenBag, new()
    {
        #region 数据源
