...
namespace DLYB.Weixin.MessageHandlers
{
    /// <summary>
    /// 微信请求的集中处理方法
    /// 此方法中所有过程，都基于DLYB.Weixin的基础功能，只为简化代码而设。
    /// </summary>
        ...
        where TResponse : IResponseMessageBase
    {
        ...
        /// 如果是DLYB.Weixin.QY，则应当和ResponseDocument一致；如果是DLYB.Weixin.QY，则应当在ResponseDocument基础上进行加密
        /// </summary>
        ...
        public MessageHandler(Stream inputStream, int maxRecordCount = 0, object postData = null,bool isDebug=false)
        {
            _isDebug = isDebug;
        ...
        /// <param name="maxRecordCount"></param>
        /// <param name="postData">需要传入到Init的参数</param>
        public MessageHandler(XDocument postDataDocument, int maxRecordCount = 0, object postData = null, bool isDebug = false)
        {
            _isDebug = isDebug;
            CommonInitialize(postDataDocument, maxRecordCount, postData);
        }
        ...
        /// <param name="maxRecordCount"></param>
        /// <param name="postData">需要传入到Init的参数</param>
        public MessageHandler(RequestMessageBase requestMessageBase, int maxRecordCount = 0, object postData = null, bool isDebug = false)
        {
            ...
            //此方法不执行任何方法，提供给具体的类库进行测试使用，例如DLYB.Weixin.QY
        }
