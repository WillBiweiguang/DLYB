...
namespace DLYB.Weixin.QY.CommonAPIs
{
    ...
    public partial class CommonApi
    {
        ...
        public static AccessTokenResult GetToken(string corpId, string corpSecret, string type = "")
        {
            #region 主动调用的频率限制
            /*
...
*/
        ...
        /// <param name="corpSecret"></param>
        /// <returns></returns>
        public static JsApiTicketResult GetTicket(string corpId, string corpSecret, string type = "jsapi")
        {
