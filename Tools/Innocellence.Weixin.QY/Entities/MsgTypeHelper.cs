...
namespace DLYB.Weixin.QY.Helpers
{
    public static class MsgTypeHelper
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static RequestMsgType GetRequestMsgType(XElement doc)
        {
            return GetRequestMsgType(doc.Element("MsgType").Value);
        }
        /// <summary>
        /// 根据xml信息，返回RequestMsgType
        /// </summary>
        ...
        /// </summary>
        /// <returns></returns>
        public static AgentType GetResponseAgentType(string str)
        {
            return (AgentType)Enum.Parse(typeof(AgentType), str, true);
        }
    }
}
