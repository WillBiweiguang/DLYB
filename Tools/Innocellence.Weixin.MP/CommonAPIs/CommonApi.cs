...
namespace DLYB.Weixin.MP.CommonAPIs
{
    ...
    public partial class CommonApi
    {
        ...
        /// <returns></returns>
        public static WeixinUserInfoResult GetUserInfo(string AppId, string AppSecret, string openId)
        {
        ...
        {
           // var accessToken = AccessTokenContainer.GetToken(appId, secret);
            return GetTicketByAccessToken(appId, secret);
        }
        ...
        /// <param name="type"></param>
        /// <returns></returns>
        public static JsApiTicketResult GetTicketByAccessToken(string AppId, string AppSecret, string type = "jsapi")
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
        {
