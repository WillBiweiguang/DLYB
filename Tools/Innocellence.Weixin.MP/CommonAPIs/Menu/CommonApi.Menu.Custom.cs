...
namespace DLYB.Weixin.MP.CommonAPIs
{
    public partial class CommonApi
    {
        ...
        /// <returns></returns>
        public static WxJsonResult CreateMenu(string AppId, string AppSecret, ButtonGroup buttonData, int timeOut = Config.TIME_OUT)
        {
        ...
        /// <param name="buttonData">菜单内容</param>
        /// <returns></returns>
        public static WxJsonResult CreateMenu(string AppId, string AppSecret, object buttonData, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var urlFormat = "https://api.weixin.qq.com/cgi-bin/menu/create?access_token={0}";
        ...
        /// <returns></returns>
        public static GetMenuResult GetMenu(string AppId, string AppSecret)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="accessToken"></param>
        /// <returns></returns>
        public static WxJsonResult DeleteMenu(string AppId, string AppSecret)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
