...
namespace Innocellence.Weixin.MP.CommonAPIs
{
    public static class CommonJsonSend
    {
        ...
        /// <returns></returns>
        //[Obsolete("此方法已过期，请使用Innocellence.Weixin.CommonAPIs.CommonJsonSend.Send()方法")]
        public static WxJsonResult Send(string accessToken, string urlFormat, object data, CommonJsonSendType sendType = CommonJsonSendType.POST, int timeOut = Config.TIME_OUT, bool checkValidationResult = false, JsonSetting jsonSetting = null/*, int retry40001ErrorTimes = 0*/)
        {
            ...
            try
            {
                result = Innocellence.Weixin.CommonAPIs.CommonJsonSend.Send(accessToken, urlFormat, data, sendType, timeOut,
        ...
        /// <param name="jsonSetting"></param>
        /// <returns></returns>
        //[Obsolete("此方法已过期，请使用Innocellence.Weixin.CommonAPIs.CommonJsonSend.Send<T>()方法")]
        ...
        {
            return Innocellence.Weixin.CommonAPIs.CommonJsonSend.Send<T>(accessToken, urlFormat, data, sendType, timeOut, checkValidationResult, jsonSetting);
        }
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        [Obsolete("此方法已过期，请使用Innocellence.Weixin.CommonAPIs.CommonJsonSend.SendAsync()方法")]
        ...
        /// <returns></returns>
        [Obsolete("此方法已过期，请使用Innocellence.Weixin.CommonAPIs.CommonJsonSend.SendAsync<T>()方法")]
