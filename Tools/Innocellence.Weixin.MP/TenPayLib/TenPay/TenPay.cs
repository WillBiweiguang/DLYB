...
namespace DLYB.Weixin.MP.AdvancedAPIs
{
    ...
    public static class TenPay
    {
        ...
        public static WxJsonResult Delivernotify(string appId, string appSecret, string openId, string transId, string out_Trade_No, string deliver_TimesTamp, string deliver_Status, string deliver_Msg, string app_Signature, string sign_Method = "sha1")
        {
            var accessToken = DLYB.Weixin.MP.CommonAPIs.AccessTokenContainer.GetToken(appId, appSecret);
        ...
        /// <param name="app_Signature">签名</param>
        /// <param name="sign_Method">签名方法</param>
        public static OrderqueryResult Orderquery(string appId, string appSecret, string package, string timesTamp, string app_Signature, string sign_Method)
        {
            var accessToken = DLYB.Weixin.MP.CommonAPIs.AccessTokenContainer.GetToken(appId, appSecret);
