...
using DLYB.Weixin.MP.AdvancedAPIs.Url;

namespace DLYB.Weixin.MP.AdvancedAPI
{
    /// <summary>
    /// 长短链接接口
    /// </summary>
    public class UrlApi
    {
        ...
        */
        ...
        public static ShortUrlResult ShortUrl(string AppId, string AppSecret, string action, string longUrl, int timeOut = Config.TIME_OUT)
        {
