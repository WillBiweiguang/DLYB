...
using DLYB.Weixin.MP.AdvancedAPIs.Semantic;
...
namespace DLYB.Weixin.MP.AdvancedAPIs
{
    ...
    public static class SemanticApi
    {
        ...
        /// <returns></returns>
        public static T SemanticSend<T>(string AppId, string AppSecret, SemanticPostData semanticPostData, int timeOut = Config.TIME_OUT) where T : WxJsonResult
        {
