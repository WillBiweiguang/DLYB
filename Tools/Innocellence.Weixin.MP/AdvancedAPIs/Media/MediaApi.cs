...
using DLYB.Weixin.MP.AdvancedAPIs.Media;
...
namespace DLYB.Weixin.MP.AdvancedAPIs
{
    ...
    public static class MediaApi
    {
        ...
        /// <returns></returns>
        public static UploadTemporaryMediaResult UploadTemporaryMedia(string AppId, string AppSecret, UploadMediaFileType type, string file, int timeOut = Config.TIME_OUT)
        {
        ...
        /// </summary>
        /// <param name="AppId">Token</param>
        /// <param name="news">图文消息组</param>
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static UploadTemporaryMediaResult UploadTemporaryNews(string AppId, string AppSecret, int timeOut = Config.TIME_OUT, params NewsModel[] news)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static UploadForeverMediaResult UploadNews(string AppId, string AppSecret, int timeOut = Config.TIME_OUT, params NewsModel[] news)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static UploadForeverMediaResult UploadForeverMedia(string AppId, string AppSecret, string file, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static UploadForeverMediaResult UploadForeverMedia(string AppId, string AppSecret, Stream fileStream,string strFile, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var url = string.Format("https://api.weixin.qq.com/cgi-bin/material/add_material?access_token={0}", accessToken.AsUrlData());
                ...
                var dataDictionary = new Dictionary<string, Stream>();

                dataDictionary.Add(strFile, fileStream);


                var fileDictionary = new Dictionary<string, string>();
                //fileDictionary["type"] = UploadMediaFileType.image.ToString();//不提供此参数也可以上传成功
                fileDictionary["media"] = strFile;
                return Post.PostFileGetJson<UploadForeverMediaResult>(url, null,dataDictionary, fileDictionary, null, timeOut: timeOut);
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static UploadForeverMediaResult UploadForeverVideo(string AppId, string AppSecret, string file, string title, string introduction, int timeOut = 40000)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var url = string.Format("https://api.weixin.qq.com/cgi-bin/material/add_material?access_token={0}", accessToken.AsUrlData());
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static GetNewsResultJson GetForeverNews(string AppId, string AppSecret, string mediaId, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static WxJsonResult DeleteForeverMedia(string AppId, string AppSecret, string mediaId, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <returns></returns>
        public static WxJsonResult UpdateForeverNews(string AppId, string AppSecret, string mediaId, int? index, NewsModel news, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="AppId"></param>
        /// <returns></returns>
        public static GetMediaCountResultJson GetMediaCount(string AppId, string AppSecret)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static MediaList_NewsResult GetNewsMediaList(string AppId, string AppSecret, int offset, int count, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <returns></returns>
        public static MediaList_OthersResult GetOthersMediaList(string AppId, string AppSecret, UploadMediaFileType type, int offset,
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static UploadImgResult UploadImg(string AppId, string AppSecret, string file, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
