...
namespace DLYB.Weixin.MP.AdvancedAPIs
{
    ...
    public static class GroupMessageApi
    {
        ...
        /// <returns></returns>
        public static SendResult SendGroupMessageByGroupId(string AppId, string AppSecret, string groupId, string value, GroupMessageType type, bool isToAll = false, int timeOut = Config.TIME_OUT)
        {
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static SendResult SendGroupMessageByOpenId(string AppId, string AppSecret, GroupMessageType type, string value, int timeOut = Config.TIME_OUT, params string[] openIds)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static SendResult SendVideoGroupMessageByOpenId(string AppId, string AppSecret, string title, string description, string mediaId, int timeOut = Config.TIME_OUT, params string[] openIds)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                const string urlFormat = "https://api.weixin.qq.com/cgi-bin/message/mass/send?access_token={0}";
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static WxJsonResult DeleteSendMessage(string AppId, string AppSecret, string msgId, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static SendResult SendGroupMessagePreview(string AppId, string AppSecret, GroupMessageType type, string value, string openId, string wxName = null, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <returns></returns>
        public static SendResult WxCardGroupMessagePreview(string AppId, string AppSecret, string cardId, string code,
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static GetSendResult GetGroupMessageResult(string AppId, string AppSecret, string msgId, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static VideoMediaIdResult GetVideoMediaIdResult(string AppId, string AppSecret, string mediaId, string title,
