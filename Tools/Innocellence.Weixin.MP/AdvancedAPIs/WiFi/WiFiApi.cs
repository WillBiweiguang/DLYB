...
using DLYB.Weixin.MP.AdvancedAPIs.WiFi;
...
namespace DLYB.Weixin.MP.AdvancedAPIs
{
    public static class WiFiApi
    {
        ...
        /// <returns></returns>
        public static WxJsonResult AddDevice(string AppId, string AppSecret, long shopId, string ssid, string password, string bssid, int timeOut = Config.TIME_OUT)
        {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static GetDeviceListResult GetDeviceList(string AppId, string AppSecret, int pageIndex = 1, int pageSize = 10,
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static WxJsonResult DeleteDevice(string AppId, string AppSecret, string bssid, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static WxJsonResult GetQrcode(string AppId, string AppSecret, long shopId, int imgId, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static WxJsonResult SetHomePage(string AppId, string AppSecret, long shopId, string url = null, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static GetHomePageResult GetHomePage(string AppId, string AppSecret, long shopId, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static GetStatisticsResult GetStatistics(string AppId, string AppSecret, string beginDate, string endDate, long shopId = -1,
