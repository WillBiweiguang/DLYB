...
using DLYB.Weixin.MP.AdvancedAPIs.QrCode;
...
namespace DLYB.Weixin.MP.AdvancedAPIs
{
    ...
    public static class QrCodeApi
    {
        ...
        /// <returns></returns>
        public static CreateQrCodeResult Create(string AppId, string AppSecret, int expireSeconds, int sceneId, int timeOut = Config.TIME_OUT)
        {
        ...
        /// <returns></returns>
        public static CreateQrCodeResult CreateByStr(string AppId, string AppSecret, string sceneStr, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var urlFormat = "https://api.weixin.qq.com/cgi-bin/qrcode/create?access_token={0}";
