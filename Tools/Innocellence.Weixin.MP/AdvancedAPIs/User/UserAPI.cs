...
using DLYB.Weixin.MP.AdvancedAPIs.User;
...
namespace DLYB.Weixin.MP.AdvancedAPIs
{
    ...
    public static class UserApi
    {
        ...
        /// <returns></returns>
        public static UserInfoJson Info(string AppId, string AppSecret, string openId, Language lang = Language.zh_CN)
        {
        ...
        /// <returns></returns>
        public static OpenIdResultJson Get(string AppId, string AppSecret, string nextOpenId)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <returns></returns>
        public static WxJsonResult UpdateRemark(string AppId, string AppSecret, string openId, string remark, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <returns></returns>
        public static BatchGetUserInfoJson BatchGetUserInfo(string AppId, string AppSecret, List<BatchGetUserInfoData> userList, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
