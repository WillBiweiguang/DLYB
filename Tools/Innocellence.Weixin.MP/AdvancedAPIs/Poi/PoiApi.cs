...
using DLYB.Weixin.MP.AdvancedAPIs.Poi;
...
namespace DLYB.Weixin.MP.AdvancedAPIs
{
    ...
    public static class PoiApi
    {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static WxJsonResult AddPoi(string AppId, string AppSecret, CreateStoreData createStoreData,
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static GetStoreResultJson GetPoi(string AppId, string AppSecret, string poiId, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static GetStoreListResultJson GetPoiList(string AppId, string AppSecret, int begin, int limit = 20, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static WxJsonResult DeletePoi(string AppId, string AppSecret, string poiId, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="AppId"></param>
        /// <returns></returns>
        public static GetCategoryResult GetCategory(string AppId, string AppSecret)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
