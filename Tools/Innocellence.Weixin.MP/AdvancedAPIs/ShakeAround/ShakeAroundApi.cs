...
using DLYB.Weixin.MP.AdvancedAPIs.ShakeAround;
...
namespace DLYB.Weixin.MP.AdvancedAPIs
{
    ...
    public static class ShakeAroundApi
    {
        ...
        /// <returns></returns>
        public static WxJsonResult Register(string AppId, string AppSecret, RegisterData data, int timeOut = Config.TIME_OUT)
        {
        ...
        /// <param name="AppId"></param>
        /// <returns></returns>
        public static GetAuditStatusResultJson GetAuditStatus(string AppId, string AppSecret)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static DeviceApplyResultJson DeviceApply(string AppId, string AppSecret, int quantity, string applyReason, string comment = null, long? poiId = null, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static WxJsonResult DeviceUpdate(string AppId, string AppSecret, long deviceId, string uuId, long major, long minor, string comment, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static WxJsonResult DeviceBindLocatoin(string AppId, string AppSecret, long deviceId, string uuId, long major, long minor, long poiId, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static DeviceSearchResultJson SearchDeviceById(string AppId, string AppSecret, List<DeviceApply_Data_Device_Identifiers> deviceIdentifiers, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var data = new
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static DeviceSearchResultJson SearchDeviceByRange(string AppId, string AppSecret, int begin, int count, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var data = new
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static DeviceSearchResultJson SearchDeviceByApplyId(string AppId, string AppSecret, long applyId, int begin, int count, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var data = new
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static UploadImageResultJson UploadImage(string AppId, string AppSecret, string file, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static AddPageResultJson AddPage(string AppId, string AppSecret, string title, string description, string pageUrl,
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static UpdatePageResultJson UpdatePage(string AppId, string AppSecret, long pageId, string title, string description, string pageUrl,
            string iconUrl, string comment = null, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static SearchPagesResultJson SearchPagesByPageId(string AppId, string AppSecret, long[] pageIds,
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static SearchPagesResultJson SearchPagesByRange(string AppId, string AppSecret, int begin, int count,
            int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static WxJsonResult DeletePage(string AppId, string AppSecret, long[] pageIds, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static WxJsonResult BindPage(string AppId, string AppSecret, DeviceApply_Data_Device_Identifiers deviceIdentifier, long[] pageIds, ShakeAroundBindType bindType, ShakeAroundAppendType appendType, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static RelationSearchResultJson RelationSearch(string AppId, string AppSecret, DeviceApply_Data_Device_Identifiers deviceIdentifier, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static RelationSearchResultJson RelationSearch(string AppId, string AppSecret, long pageId, int begin, int count, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var url = string.Format("https://api.weixin.qq.com/shakearound/relation/search?access_token={0}", accessToken.AsUrlData());
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static GetShakeInfoResultJson GetShakeInfo(string AppId, string AppSecret, string ticket, int needPoi = 1,
            int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static StatisticsResultJson StatisticsByDevice(string AppId, string AppSecret,
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static StatisticsResultJson StatisticsByPage(string AppId, string AppSecret,
