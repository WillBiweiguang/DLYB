...
using DLYB.Weixin.MP.AdvancedAPIs.TemplateMessage;
...
namespace DLYB.Weixin.MP.AdvancedAPIs
{
    ...
    public static class TemplateApi
    {
        ...
        /// <returns></returns>
        public static SendTemplateMessageResult SendTemplateMessage(string AppId, string AppSecret, string openId, string templateId, string topcolor, string url, object data, int timeOut = Config.TIME_OUT)
        {
