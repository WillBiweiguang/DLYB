...
namespace DLYB.Owin.Security.SAML
{
    ...
    /// </summary>
    public class SAML2AuthenticationOptions : AuthenticationOptions
    {
        ...
        public SAML2AuthenticationOptions()
            : this(SAML2AuthenticationDefaults.AuthenticationType)
        {
        }
        ...
        [SuppressMessage("Microsoft.Globalization", "CA1303:Do not pass literals as localized parameters",
            MessageId = "DLYB.Owin.Security.SAML.SAMLAuthenticationOptions.set_Caption(System.String)", Justification = "Not a LOC field")]
        public SAML2AuthenticationOptions(string authenticationType)
            : base(authenticationType)
        {
            AuthenticationMode = AuthenticationMode.Passive;
            Caption = SAML2AuthenticationDefaults.Caption;
            _tokenValidationParameters = new TokenValidationParameters();
            BackchannelTimeout = TimeSpan.FromMinutes(1);
            UseTokenLifetime = true;
            RefreshOnIssuerKeyNotFound = true;
            CallbackPath = new List<PathString>();
        }
        ...
        /// </summary>
        public SAML2AuthenticationNotifications Notifications { get; set; }
        ...
        /// </summary>
        public IList<PathString> CallbackPath { get; set; }
        ...
        public X509Certificate2 SPServiceCertificate { get; set; }
